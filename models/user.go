...
func (o *User) StudentG(mods ...qm.QueryMod) studentQuery {
	return o.Student(boil.GetDB(), mods...)
}

// Student pointed to by the foreign key.
func (o *User) Student(exec boil.Executor, mods ...qm.QueryMod) studentQuery {
...
// ModeratorResumeReviews retrieves all the resume_review's resume review with an executor via moderator_id column.
func (o *User) ModeratorResumeReviews(exec boil.Executor, mods ...qm.QueryMod) resumeReviewQuery {
	queryMods := []qm.QueryMod{
		qm.Select("\"a\".*"),
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"a\".\"moderator_id\"=?", o.UserID),
	)

	query := ResumeReviews(exec, queryMods...)
	queries.SetFrom(query.Query, "\"resume_review\" as \"a\"")
	return query
}

// WorksForsG retrieves all the works_for's works for.
func (o *User) WorksForsG(mods ...qm.QueryMod) worksForQuery {
	return o.WorksFors(boil.GetDB(), mods...)
}

// WorksFors retrieves all the works_for's works for with an executor.
func (o *User) WorksFors(exec boil.Executor, mods ...qm.QueryMod) worksForQuery {
	queryMods := []qm.QueryMod{
		qm.Select("\"a\".*"),
	}
...
func (userL) LoadStudent(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"student\" where \"user_id\" in (%s)",
...
// LoadModeratorResumeReviews allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (userL) LoadModeratorResumeReviews(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"resume_review\" where \"moderator_id\" in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
	...
	results, err := e.Query(query, args...)
	if err != nil {
		return errors.Wrap(err, "failed to eager load resume_review")
	}
	defer results.Close()

	var resultSlice []*ResumeReview
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice resume_review")
	}
	...
	if singular {
		object.R.ModeratorResumeReviews = resultSlice
		return nil
	}

	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UserID == foreign.ModeratorID {
				local.R.ModeratorResumeReviews = append(local.R.ModeratorResumeReviews, foreign)
				break
			}
		}
	}
...
// LoadWorksFors allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (userL) LoadWorksFors(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"works_for\" where \"user_id\" in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
...
func (o *User) SetStudentG(insert bool, related *Student) error {
	return o.SetStudent(boil.GetDB(), insert, related)
}

// SetStudentP of the user to the related item.
// Sets o.R.Student to related.
// Adds o to related.R.User.
// Panics on error.
func (o *User) SetStudentP(exec boil.Executor, insert bool, related *Student) {
	if err := o.SetStudent(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetStudentGP of the user to the related item.
// Sets o.R.Student to related.
// Adds o to related.R.User.
// Uses the global database handle and panics on error.
func (o *User) SetStudentGP(insert bool, related *Student) {
	if err := o.SetStudent(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetStudent of the user to the related item.
// Sets o.R.Student to related.
// Adds o to related.R.User.
func (o *User) SetStudent(exec boil.Executor, insert bool, related *Student) error {
	var err error
...
// AddModeratorResumeReviewsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ModeratorResumeReviews.
// Sets related.R.Moderator appropriately.
// Uses the global database handle.
func (o *User) AddModeratorResumeReviewsG(insert bool, related ...*ResumeReview) error {
	return o.AddModeratorResumeReviews(boil.GetDB(), insert, related...)
}

// AddModeratorResumeReviewsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ModeratorResumeReviews.
// Sets related.R.Moderator appropriately.
// Panics on error.
func (o *User) AddModeratorResumeReviewsP(exec boil.Executor, insert bool, related ...*ResumeReview) {
	if err := o.AddModeratorResumeReviews(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddModeratorResumeReviewsGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ModeratorResumeReviews.
// Sets related.R.Moderator appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddModeratorResumeReviewsGP(insert bool, related ...*ResumeReview) {
	if err := o.AddModeratorResumeReviews(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddModeratorResumeReviews adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ModeratorResumeReviews.
// Sets related.R.Moderator appropriately.
func (o *User) AddModeratorResumeReviews(exec boil.Executor, insert bool, related ...*ResumeReview) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ModeratorID = o.UserID
			if err = rel.Insert(exec); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
			...
			values := []interface{}{o.UserID, rel.ResumeID, rel.ModeratorID}
	...
	if o.R == nil {
		o.R = &userR{
			ModeratorResumeReviews: related,
		}
	} else {
		o.R.ModeratorResumeReviews = append(o.R.ModeratorResumeReviews, related...)
	}
...
// AddWorksForsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WorksFors.
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddWorksForsG(insert bool, related ...*WorksFor) error {
	return o.AddWorksFors(boil.GetDB(), insert, related...)
}

// AddWorksForsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WorksFors.
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddWorksForsP(exec boil.Executor, insert bool, related ...*WorksFor) {
	if err := o.AddWorksFors(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddWorksForsGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WorksFors.
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddWorksForsGP(insert bool, related ...*WorksFor) {
	if err := o.AddWorksFors(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddWorksFors adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WorksFors.
// Sets related.R.User appropriately.
func (o *User) AddWorksFors(exec boil.Executor, insert bool, related ...*WorksFor) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.JobID, rel.UserID}
	...
	if o.R == nil {
		...
		o.R.WorksFors = append(o.R.WorksFors, related...)
	}
...
func FindUserG(userID float64, selectCols ...string) (*User, error) {
	return FindUser(boil.GetDB(), userID, selectCols...)
}

// FindUserGP retrieves a single record by ID, and panics on error.
func FindUserGP(userID float64, selectCols ...string) *User {
...
func FindUser(exec boil.Executor, userID float64, selectCols ...string) (*User, error) {
	userObj := &User{}
...
func FindUserP(exec boil.Executor, userID float64, selectCols ...string) *User {
...
func UserExistsP(exec boil.Executor, userID float64) bool {
